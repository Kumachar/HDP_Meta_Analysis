#!/usr/bin/env bash
#SBATCH --job-name=hdp_regen_prev
#SBATCH --account=
...
#SBATCH --output=logs/regen_prev_%j.out
#SBATCH --error=logs/regen_prev_%j.err
...
CMD=(
  python -u regen_prev_summary.py
...
echo "[DONE] Regenerated previous-style beta summary tables."